...
/**
 * uses <b>MIPMAP</b> folder to get the icon drawables.
 */
public class TextViewWithImages extends android.support.v7.widget.AppCompatTextView
{
    ...
    {
        final Spannable spannable = getTextWithImages(getContext(), text, getLineHeight(), ContextCompat.getColor(getContext(), R.color.colorAccent));
