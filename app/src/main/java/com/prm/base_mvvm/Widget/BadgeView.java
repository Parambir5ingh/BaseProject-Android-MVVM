...
/**
 * Custom text view to show badge count ,somewhat same like we see in whats app. (count with a circle background.)
 */
public class BadgeView extends android.support.v7.widget.AppCompatTextView
{
    ...
    /**
     * Show badge count in form of {@link String} ,it may be any string value.
     *
     * @param count-string to be displayed
     */
    ...
    /**
     * Show badge count in form of {@link Integer} ,it may be any int value.
     * and will be hide if  count == 0
     *
     * @param count-string to be displayed
     */
    ...
    /**
     * @param color - color code which needs to be set as background.
     */
    ...
    private class OvalShadow extends OvalShape
    {
        ...
        {
            final int viewWidth  = BadgeView.this.getWidth();
            final int viewHeight = BadgeView.this.getHeight();
