package com.prm.base_mvvm.ProjectUtils.ContactStuff;
...
{
    private Context                        con;
    private BaseCallBack<List<ContactsModel>> callBack;

    public GetAllContacts(Context con, BaseCallBack<List<ContactsModel>> callBack)
    {
        this.con = con;
...
//
    ...
    protected void onPostExecute(List<ContactsModel> contactsModels)
    {
        ...
        callBack.onCallBack(new ArrayList<>(setModel));
