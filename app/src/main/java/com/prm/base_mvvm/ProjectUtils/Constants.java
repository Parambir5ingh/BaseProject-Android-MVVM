...
{
    String FB_ID = "470556126670526";
    String YOUTUBE_TUTORIAL = "https://www.youtube.com/watch?v=PXinUYtWKNs";
    ...
    @interface Extras
    {
        ...
        String TITLE = "title";
        String DATA2 = "isTrue";
        String startingUrl = "startingUrl";
        String currentUrl = "currentUrl";
        String isVideo = "isVideo";
        String WEB_STACK = "WEB_STACK";
        String IS_PLAYER_RESUME = "IS_PLAYER_RESUME";
        String openComments = "openComments";
        String tabNumber = "tabNumber";
